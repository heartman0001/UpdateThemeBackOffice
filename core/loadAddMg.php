    ...
    <form action="?" method="get" name="myForm" id="myForm">
        ...
        <div class="divRightNav">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php echo  $valLinkNav1 ?>" target="_self"><?php echo  $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('../core/menuManage.php')" target="_self"><?php echo  $valNav2 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo  $langTxt["mg:crepermis"] ?><?php if ($_REQUEST["myParentID"] >= 1) { ?> (<?php echo  $valName ?>)<?php } ?></span></td>
        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                ...
                <tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <label>
                            <div class="formDivRadioL"><input name="inputIconType" id="inputIconType" type="radio" class="formRadioContantTb" checked="checked" value="1" onclick="
                        ...
                        <label>
                            <div class="formDivRadioL"><input name="inputIconType" id="inputIconType" type="radio" class="formRadioContantTb" value="2" onclick="
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <div class="menu-icon">
                            <div class="menu-icon-block">
                                <img src="<?= $valIcon ?>" name="LibraryIconSample" id="LibraryIconSample" onerror="this.src='<?= "../img/btn/blank.gif" ?>'" />
                                <input name="inputIconName" type="hidden" id="inputIconName" placeholder="เลือกไอคอน" value="<?= $valIcon ?>" />
                            </div>
                            <div class="menu-icon-select">
                                <a href="javascript:void(0)" onclick="popup('popupIconWindow','menuMgIcon.php',500,210,1)"><?= $langTxt["mg:inpiconAd"] ?></a>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr id="icon-class" style="display:none;">
                    <td width="18%" align="right" valign="top" class="formLeftContantTb"><?= $langTxt["mg:inpiconPick"] ?></td>
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <div class="menu-icon">
                            <input name="inputClassIcon" id="inputClassIcon" type="text" class="menu-icon-block" placeholder="เลือกไอคอน"    <?php echo $langTxt["mg:inpiconclassS"]; ?>" value="<?php echo $valClassName; ?>" />
                            <div class="menu-icon-select">
